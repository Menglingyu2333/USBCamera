...
void EXTI0_Config(void)
{
	...
	GPIO_Init(GPIOB, &GPIO_InitStructure);                       ///<Configure PA.00 pin as input floating

	RCC_APB2PeriphClockCmd(RCC_APB2PERIPH_AFIO, ENABLE);         ///<Enable AFIO clock
	GPIO_EXTILineConfig(GPIO_PortSourceGPIOB, GPIO_PinsSource13); ///<Connect EXTI0 Line to PA0 pin
