...
//
//  /* 2.3.3 Interface Association Descriptor */
//  8, /* bLength */
...
//
//  /* 2.3.4 VideoControl Interface Descriptor */
//
//  /* 2.3.4.1 Standard VC Interface Descriptor = interface 0 */
//  9, /* bLength */
...
//  PC_PROTOCOL_15, /* bInterfaceProtocol */
//  0x00,//UVC_USR_STR_VC_ITF, /* iInterface */
//
//  /* 2.3.4.2 Class-specific VC Interface Descriptor */
//  12+1, /* bLength */
...
//  1, /* baInterfaceNr(1) */
//
////  /* 2.3.4.3 Input Terminal Descriptor (Camera) */
////  15+2, /* bLength */
////  CS_INTERFACE, /* bDescriptorType */
...
////  0x00, /* bAssocTerminal */
////  0x00,//UVC_USR_STR_VC_IT, /* iTerminal */
...
//
//  /* 2.3.4.4 Input Terminal Descriptor (Composite) */
//  0x08,                                 /* bLength */
...
//  WBVAL(COMPOSITE_CONNECTOR),                           /* wTerminalType: 0x0401 COMPOSITE_CONNECTOR type. This terminal is the composite connector. */
//  0x00,                                 /* bAssocTerminal: No association */
//  0x00,                                 /* iTerminal: Unused*/
//
//  /* 2.3.4.5 Output Terminal Descriptor */
//  9, /* bLength */
//  CS_INTERFACE, /* bDescriptorType */
...
//  0x00, /* bAssocTerminal */
//  0x05, /* bSourceID: The input pin of this unit is connected to the output pin of unit 5. */
//  0x00,//UVC_USR_STR_VC_OT, /* iTerminal */
//
////  /* 2.3.4.6 Selector Unit Descriptor */
////  8, /* bLength */
////  CS_INTERFACE, /* bDescriptorType */
////  VC_SELECTOR_UNIT, /* bDescriptorSubtype */
////  0x04, /* bUnitID */
////  0x02, /* bNrInPins */
////  0x01, /* baSourceID(1): Input 1 of this unit is connected to unit ID 0x01 每 the CAMERA TERMINAL (CMOS sensor). */
////  0x02, /* baSourceID(2): Input 2 of this unit is connected to unit ID 0x02 每 the composite connector. */
////  0x00,//UVC_USR_STR_VC_OT, /* iTerminal */
////
...
////  0x05, /* bUnitID */
////  0x04, /* bSourceID: This input pin of this unit is connected to the output pin of unit with ID 0x04. */
////  WBVAL(0x0000), /* wMaxMultiplier */
////  0x03, /* bControlSize: Size of the bmControls field, in bytes. */
////  WBVAL(0x0000), /* bmControls */
////  0x00, /* iProcessing */
...
//};
{
  ...
  SC_VIDEO_INTERFACE_COLLECTION, /* bFunctionSubClass  */
  PC_PROTOCOL_UNDEFINED,         /* bInterfaceProtocol */
  0x00,//UVC_USR_STR_IAD, /* iFunction */
...
//  0x01, /* bFrameIndex */
//  0x02, /* bmCapabilities: fixed frame-rate */
//  WBVAL(ImageWidth), /* wWidth */
//  WBVAL(ImageHeight), /* wHeight */
//  DBVAL(MIN_BIT_RATE), /* dwMinBitRate */
//  DBVAL(MAX_BIT_RATE), /* dwMaxBitRate */
//  DBVAL(MAX_FRAME_SIZE), /* dwMaxVideoFrameBufSize */
//  DBVAL(FRAME_INTERVEL), /* dwDefaultFrameInterval: for 5 FPS */
//  1, /* bFrameIntervalType */
//  DBVAL(FRAME_INTERVEL), /* dwFrameInterval(1) */
...
//    0x01,                               /* endpoints, 0 “C no bandwidth used */
//    0x0e,                               /* CC_VIDEO */
