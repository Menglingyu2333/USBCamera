...
//  MAKE_WORD(CAMERA_SIZ_CONFIG_DESC),    /* wTotalLength  0x90 bytes*/
//  0x02,                                 /* bNumInterfaces */
...
//  MAKE_WORD(0x0100),                    /* bcdUVC : Revision of class specification that this device is based upon. For this example, the device complies with Video Class specification version 1.0 */
//  MAKE_WORD(VC_DESC_TOTAL_SIZE),        /* wTotalLength : Total size of class-specific descriptors*/
//  MAKE_DWORD(6000000),                  /* dwClockFrequency : 0x005b8d80 -> 6,000,000 == 6MHz*/
...
//  0x01, /* bTerminalID */
//  MAKE_WORD(0x0201), /* wTerminalType */
//  0x00, /* bAssocTerminal */
//  0x14, /* iTerminal */
//  MAKE_WORD(0x0000), /* wObjectiveFocalLengthMin */
//  MAKE_WORD(0x0000), /* wObjectiveFocalLengthMax */
//  MAKE_WORD(0x0000), /* wOcularFocalLength       */
//  2,             /* bControlSize */
//  0x00, 0x00,    /* bmControls */
//
...
//  0x02, /* bTerminalID */
//  MAKE_WORD(0x0101), /* wTerminalType */
//  0x00, /* bAssocTerminal */
//  0x01, /* bSourceID: is connected to terminal 0x01 */
//  0x15, /* iTerminal */
//
