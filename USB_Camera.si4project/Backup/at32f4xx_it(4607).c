...
void EXTI1_IRQHandler(void)
{
  ...
  else if(frameReceived_len != 0)
  {
    if(ImageBuf_1_Ready)  //正在接收的是buf2
    {
      ImageBuf_1_Ready = 0;
      frameBuf_2_len = frameReceived_len;
      frameReceivePtr = ov2640_framebuf1_ptr;
    }
    else
    {
//      EXTI_Disable(EXTI1_IRQn);
      ...
      ImageBuf_1_Ready = 1;
      frameBuf_1_len = frameReceived_len;
      frameReceivePtr = ov2640_framebuf2_ptr;
    }
    frameReceived_len = 0;
...
//    }
//
//    printf("frameBuf_1_len=%d,validLeh=%d",frameBuf_1_len,jpegValidLen);
//    frameBuf_1_len = 0;
