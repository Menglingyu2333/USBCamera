...
void EXTI1_IRQHandler(void)
{
  ...
  else if(Frame_RcvLen != 0)
  {
    if(FrameBuf_1_Ready)  //正在接收的是buf2
    {
      FrameBuf_1_Ready = 0;
      FrameBuf_2_Len = Frame_RcvLen;
...
//      EXTI_Disable(EXTI1_IRQn);
      ...
      FrameBuf_1_Ready = 1;
      FrameBuf_1_Len = Frame_RcvLen;
      Frame_RcvPtr = FrameBuf_2_Addr;
    }
