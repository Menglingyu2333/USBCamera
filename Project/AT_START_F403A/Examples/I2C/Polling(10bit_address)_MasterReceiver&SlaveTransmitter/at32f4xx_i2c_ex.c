/**
  ******************************************************************************
  * @file    I2C/Polling(10bit_address)_MasterReceiver&SlaveTransmitter/at32f4xx_i2c_ex.c 
...
I2C_StatusType I2C_Master_Receive(I2C_Type* I2Cx, uint16_t DevAddress, uint8_t *pData, uint16_t Size, uint32_t Timeout)
{
  ...
  if(I2C_WaitOnFlagUntilTimeout(I2Cx, I2C_FLAG_ADDR10F, RESET, I2C_EVT_CHECK_NONE, Timeout) != I2C_OK)
  {
    /* Send STOP Condition */
    I2C_GenerateSTOP(I2Cx, ENABLE);
